...
execute positioned -29999999 0 1601 unless block ~ ~ ~ green_shulker_box{Items:[{Slot:2b,tag:{Durability:{Init:1b}}}]} run function artificer_durability:automatic/handle/item_init
execute positioned -29999999 0 1601 if block ~ ~ ~ green_shulker_box{Items:[{Slot:2b,tag:{Durability:{Actual:0}}}]} run function artificer_durability:automatic/handle/item_unbreakable
execute positioned -29999999 0 1601 unless block ~ ~ ~ green_shulker_box{Items:[{Slot:2b,tag:{Durability:{Actual:0}}}]} run function artificer_durability:automatic/handle/item_durability
