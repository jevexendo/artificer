...
execute as @s if data block -29999999 0 1601 Items[{Slot:1b}].tag.Damage run function artificer_durability:automatic/detect/has_offhand

# Detect what armor pieces the player is wearing [Feet:100b,Legs:101b,Chest:102b,Head:103b]
execute as @s if data block -29999999 0 1601 Items[{Slot:2b}].tag.Damage run function artificer_durability:automatic/detect/has_boots
execute as @s if data block -29999999 0 1601 Items[{Slot:3b}].tag.Damage run function artificer_durability:automatic/detect/has_leggings
execute as @s if data block -29999999 0 1601 Items[{Slot:4b}].tag.Damage run function artificer_durability:automatic/detect/has_chestplate
