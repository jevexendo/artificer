...
execute store result score $temp_0 dur.data run data get block -29999999 0 1601 Items[0].tag.Damage
execute store result score $temp_1 dur.data run data get block -29999999 0 1601 Items[0].tag.Durability.Damage
