...
execute as @s if data storage artificer_durability:temp object.tag.Enchantments[{id:"minecraft:unbreaking"}].lvl run function artificer_durability:automatic/handle/unbreaking/init
