...
scoreboard players set $temp_10 dur.data 0
execute store result score $temp_10 dur.data run data get entity @s SelectedItem.tag.Enchantments[{id:"minecraft:unbreaking"}].lvl
scoreboard players add $temp_10 dur.data 1
scoreboard players operation $temp_9 dur.data /= $temp_10 dur.data
