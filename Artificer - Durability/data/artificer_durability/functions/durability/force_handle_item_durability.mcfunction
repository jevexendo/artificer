...
# Edited By: Jevex
# Description: Master function to force item durability degradation
#
###################################################################################
...
execute store result score $temp_3 dur.data run data get storage artificer_durability:temp object.tag.Durability.Actual
...
# Force remove one additional point of durability
scoreboard players add $temp_2 dur.data 1
