...
execute as @s if data storage artificer_durability:temp object.tag.Enchantments[{id:"minecraft:unbreaking"}].lvl run function artificer_durability:durability/handle/unbreaking_init
