...
execute as @s if data entity @s Inventory[{Slot:100b}].Count run function artificer_durability:durability/process_boots
execute as @s if data entity @s Inventory[{Slot:101b}].Count run function artificer_durability:durability/process_leggings
execute as @s if data entity @s Inventory[{Slot:102b}].Count run function artificer_durability:durability/process_chestplate
execute as @s if data entity @s Inventory[{Slot:103b}].Count run function artificer_durability:durability/process_helmet
