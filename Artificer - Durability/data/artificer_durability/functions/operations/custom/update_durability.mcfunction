...
execute as @s if score $durability du.custom matches ..-1 if score $true_damage du.custom matches 0 if data storage artificer_durability:temp object.tag.Enchantments[{id:"minecraft:unbreaking"}].lvl run function artificer_durability:operations/custom/unbreaking/init
...
# DEBUG MESSAGE
execute as @s if score @s ar.debug matches 2.. run tellraw @a ["",{"text":"[Debug]","color":"red"},{"text":" > "},{"selector":"@s","color":"dark_aqua"},{"text":" Updated item damage: ","color":"yellow"},{"score":{"name":"$temp_2","objective":"du.data"},"color":"gold"}]
...
# DEBUG MESSAGE
execute as @s if score @s ar.debug matches 2.. run tellraw @a ["",{"text":"[Debug]","color":"red"},{"text":" > "},{"selector":"@s","color":"dark_aqua"},{"text":" Updating durability of item to: ","color":"yellow"},{"score":{"name":"$temp_0","objective":"du.data"},"color":"gold"}]
