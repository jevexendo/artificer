#> artificer_durability:clipboard/paste/hotbar/slot_0
#
#> Description 
#   Store item to Slot 0 from artificer durability storage
...
loot replace entity @s hotbar.0 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
