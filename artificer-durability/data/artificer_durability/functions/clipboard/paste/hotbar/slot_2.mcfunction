#> artificer_durability:clipboard/paste/hotbar/slot_2
#
#> Description 
#   Store item to Slot 2 from artificer durability storage
...
loot replace entity @s hotbar.2 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
