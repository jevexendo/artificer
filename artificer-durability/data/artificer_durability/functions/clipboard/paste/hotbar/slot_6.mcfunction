#> artificer_durability:clipboard/paste/hotbar/slot_6
#
#> Description 
#   Store item to Slot 6 from artificer durability storage
...
loot replace entity @s hotbar.6 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
