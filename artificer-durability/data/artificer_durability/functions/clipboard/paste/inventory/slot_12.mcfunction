#> artificer_durability:clipboard/paste/inventory/slot_12
#
#> Description 
#   Store item to Slot 12 from artificer durability storage
...
loot replace entity @s inventory.3 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
