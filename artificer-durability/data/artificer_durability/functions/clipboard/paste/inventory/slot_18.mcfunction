#> artificer_durability:clipboard/paste/inventory/slot_18
#
#> Description 
#   Store item to Slot 18 from artificer durability storage
...
loot replace entity @s inventory.9 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
