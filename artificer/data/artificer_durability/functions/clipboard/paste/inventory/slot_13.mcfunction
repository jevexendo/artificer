#> artificer_durability:clipboard/paste/inventory/slot_13
#
#> Description 
#   Store item to Slot 13 from artificer durability storage
...
loot replace entity @s inventory.4 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
