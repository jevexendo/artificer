#> artificer_durability:clipboard/paste/inventory/slot_31
#
#> Description 
#   Store item to Slot 31 from artificer durability storage
...
loot replace entity @s inventory.22 1 mine -29999999 0 1601 minecraft:air{drop_contents: 1b}
