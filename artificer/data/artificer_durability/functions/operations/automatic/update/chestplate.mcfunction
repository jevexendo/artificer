#> artificer_durability:operations/automatic/update/chestplate
#
#> Description
#   Update chestplate item durability
...
data modify storage artificer_durability:clipboard Item set from block -29999999 0 1601 Items[4]
...
data modify block -29999999 0 1601 Items[4] set from storage artificer_durability:clipboard Item

# Destroy item if broken
execute if score $out_0 du.data matches 1 run item replace block -29999999 0 1601 container.4 with minecraft:barrier{Null: 1b}
