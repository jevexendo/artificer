#> artificer_durability:operations/general/handle_lore
#
#> Description:
#   Update item lore to match custom durability values
...
data modify storage artificer_durability:clipboard Item.tag.display.Lore[-1] set from block -29999999 0 1602 Text1
